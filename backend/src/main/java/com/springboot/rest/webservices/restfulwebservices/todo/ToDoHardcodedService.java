...
public class ToDoHardcodedService {
    ...
    static {
        ...
        todos.add(new Todo(++idCounter, "User", "Learn Basketball", new Date(), false));
        todos.add(new Todo(++idCounter, "User", "Learn Gaming", new Date(), false));
        todos.add(new Todo(++idCounter, "User", "Learn Swimming", new Date(), false));
        todos.add(new Todo(++idCounter, "User", "Read a Book", new Date(), false));
        todos.add(new Todo(++idCounter, "User", "Write Code", new Date(), false));
        todos.add(new Todo(++idCounter, "User", "Cook Dinner", new Date(), false));
    }
